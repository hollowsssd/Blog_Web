  ...
  const [comments, setComments] = useState<Comment[]>([
    {
      ...
      author: "Nguyễn Văn A",
      date: "12/07/2025 09:20",
    },
    {
      text: "AI đúng là đang thay đổi cách viết code luôn á.",
      author: "Lê Thị B",
      date: "12/07/2025 10:05",
    },
  ]);
     ...
     <Header/>
      ...
      <section className="max-w-3xl mx-auto">
        <h1 className="text-3xl font-bold mb-3 leading-snug">
          New AI Breakthrough Revolutionizes Web Development
        </h1>
        ...
        <article className="prose prose-lg max-w-none mb-10">
          <p>
            A groundbreaking AI tool has been unveiled, transforming the way we
            build websites. This new technology leverages deep learning to write
            responsive, accessible, and fully semantic HTML/CSS code from plain
            text instructions...
          </p>
          <p>
            With this innovation, developers can save hundreds of hours in coding,
            prototyping, and debugging. The AI is capable of handling animations,
            responsive layouts, and even React integration.
          </p>
        </article>
